...
from emp_prof
where department_id = 30
WITH CHECK OPTION CONSTRAINT viz_check_constr;
...
--12
CREATE VIEW viz_emp_prof (employee_id, first_name, last_name, 
email UNIQUE DISABLE NOVALIDATE, phone_number, 
CONSTRAINT pk_viz_emp_prof PRIMARY KEY (employee_id) DISABLE NOVALIDATE) AS
...
WITH CHECK OPTION CONSTRAINT ck_name_emp_prof2; 
